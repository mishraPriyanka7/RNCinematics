...
export default class CastImageSlider extends Component {
    ...
    render() {
        ...
        return <View style={{ flex: 1 }}>
            ...
            <IndicatorViewPager style={{ flex: 1 }} indicator={this._renderIndicator()} onPageScroll={this._onPageScroll.bind(this)} autoPlayEnable onPageSelected={p => console.log(p)}>
              <Image style={styles.imageSlide} source={{ uri: IMAGE_BASE_URL_500 + this.props.data.profile_path }} />
              <Image style={styles.imageSlide} source={{ uri: IMAGE_BASE_URL_500 + this.props.data.profile_path }} />
              <Image style={styles.imageSlide} source={{ uri: IMAGE_BASE_URL_500 + this.props.data.profile_path }} />
            </IndicatorViewPager>

            <View style={{ flex: 0.3, position: "absolute", bottom: 12, marginLeft: 20 }}>
              <Image style={{ height: 110, width: 80, paddingRight: 20 }} source={{ uri: IMAGE_BASE_URL + this.props.data.profile_path }} />
            </View>
